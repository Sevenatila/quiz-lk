...
function ProtocolLoader({
  ...
  useEffect(() => {
    ...
    // Distribuir 7:12 (432 segundos) entre todos os steps
    const totalTime = 432000; // 7 minutos e 12 segundos
    const timePerStep = totalTime / protocolSteps.length;
...
export default function QuizV2() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      {showBackRedirect && (
        <div className="fixed inset-0 z-[9999] bg-black bg-opacity-95 flex items-start justify-center overflow-y-auto">
          <div className="bg-white rounded-lg sm:rounded-2xl shadow-2xl max-w-md sm:max-w-lg md:max-w-2xl w-full mx-2 sm:mx-4 my-4 sm:my-8 max-h-[90vh] overflow-y-auto animate-fadeInUp">
            {/* Header */}
